...
/*				for (x=0;x<16;x++)
				{
//					for (y=0;y<16;y++)			// pretend i'm drawing it
//					{
//				      *(screen+y+offset+ap+dn)^=box1[x][y];
					  // Do Nothing
		 ...
		 for (xx=0; xx<numspr; xx++)
	      {
		      ...
		      spx = shipanim[z].shipx;
		      spy = shipanim[z].shipy;;
		      shipanim[z].shipox = spx;
			  shipanim[z].shipoy = spy;

		      spx += shipanim[z].shipspeed;
			  if (shipanim[z].shipx >= 320)
			  {
//                      printf(".");
		      }
		      shipanim[z].shipx = spx;

		      PutImage(shipanim[z].shipox,spy,spritenum);
